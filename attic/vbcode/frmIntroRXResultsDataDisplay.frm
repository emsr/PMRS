...
Begin VB.Form frmQueryResult 
   ...
   ClientTop       =   4515
   ClientWidth     =   9060
   Icon            =   "frmIntroRXResultsDataDisplay.frx":0000
   LinkTopic       =   "Form1"
   ...
   Begin MSDBGrid.DBGrid dbgQueryResults 
      Bindings        =   "frmIntroRXResultsDataDisplay.frx":030A
      Height          =   3525
      Left            =   360
      OleObjectBlob   =   "frmIntroRXResultsDataDisplay.frx":031A
      TabIndex        =   0
      Top             =   240
      Width           =   8175
   End
...
frmProjectFeatures.cdlProject.DefaultExt = ".xls"
frmProjectFeatures.cdlProject.Filter = "Excel 97 Worksheet (*.xls)|*.xls"
DataType = "exc97"
...
frmProjectFeatures.cdlProject.DefaultExt = ".mdb"
frmProjectFeatures.cdlProject.Filter = "Access Database (*.mdb)|*.mdb"
DataType = "acces"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".xls"
frmProjectFeatures.cdlProject.Filter = "Excel 3.0 Worksheet (*.xls)|*.xls"
DataType = "exc30"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".xls"
frmProjectFeatures.cdlProject.Filter = "Excel 4.0 Worksheet (*.xls)|*.xls"
DataType = "exc40"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".xls"
frmProjectFeatures.cdlProject.Filter = "Excel 5.0, 7.0 Worksheet (*.xls)|*.xls"
DataType = "exc50"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".dbf"
frmProjectFeatures.cdlProject.Filter = "FoxPro 2.0 Database (*.dbf)|*.dbf"
DataType = "fox20"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".dbf"
frmProjectFeatures.cdlProject.Filter = "FoxPro 2.5 Database (*.dbf)|*.dbf"
DataType = "fox25"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".dbf"
frmProjectFeatures.cdlProject.Filter = "FoxPro 2.6 Database (*.dbf)|*.dbf"
DataType = "fox26"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".wk1"
frmProjectFeatures.cdlProject.Filter = "Lotus 123 (*.wk1)|*.wk1"
DataType = "lot01"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".wk3"
frmProjectFeatures.cdlProject.Filter = "Lotus 123 3.0 (*.wk3)|*.wk3"
DataType = "lot03"
Set_Export_Strings  'call sub
...
frmProjectFeatures.cdlProject.DefaultExt = ".txt"
frmProjectFeatures.cdlProject.Filter = "Comma Delimited Text (*.txt)|*.txt"
DataType = "comma"
Set_Export_Strings  'call sub
End Sub
...
If Ascending = True Then
    SortField = "[" + QueryResultsRS.Fields(dbgQueryResults.SelStartCol).Name + "]"
Else
    SortField = "[" + QueryResultsRS.Fields(dbgQueryResults.SelStartCol).Name + "] DESC"
End If
...
If Len(Trim(RXAnalysisFilterString)) > 0 Then
    Export "DISTINCT pnt_introrx_results.*", "pnt_introrx_results,pnt_txsites", "pnt_introrx_results.TXID=pnt_txsites.PointID and " + RXAnalysisFilterString
Else
    Export "pnt_introrx_results.*", "pnt_introrx_results", RXAnalysisFilterString
End If
